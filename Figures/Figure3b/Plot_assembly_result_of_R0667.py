...
# Load bar chart data
bar_data = load_data('R0667_plasmidB_consensus_bit_error.csv')
bar_colors = [(92/255,111/255,180/255)]
# (255/255,203/255,158/255)
...
line_data = load_data('R0667_plasmidB_recovery_rate.csv')
line_colors = [(252/255,141/255,58/255)]
# (252/255,141/255,58/255)
line_markers = ['^']
line_styles = ['-']
...
ax1.set_xticklabels(['9.03×', '13.65×', '18.14×', '22.58×', '26.97×', '31.48×', '35.90×'], rotation=25)
...
plt.tight_layout()
plt.savefig('Figure2b-Assembly-Performance-of-R0667.pdf', dpi=600, bbox_inches='tight',transparent=True)
plt.show()