...
data_path = 'Time_with_different_segment_length.csv'
...
plt.xticks([1, 2, 3, 4, 5], ['100', '200', '500', '1000', '1500'],rotation=45, fontsize=8)  # Setting custom x-axis tick labels
...
plt.tight_layout()
# Sive the plot
plt.savefig('Figure5f-Time.pdf', dpi=600, bbox_inches='tight',transparent=True)
